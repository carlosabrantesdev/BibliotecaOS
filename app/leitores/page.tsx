    ...
    <div className="flex flex-col min-h-screen bg-[#f7f9fb] text-[#191c1e]">
      <div className="p-8 flex-1">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#45464d] mb-8">Gerencie os leitores da biblioteca</p>

          <div className="bg-white border border-[#c6c6cd]/50 rounded-xl p-8 text-center">
            <span className="material-symbols-outlined text-[#c6c6cd] text-6xl mb-4">group</span>
            <h2 className="text-xl font-semibold text-[#191c1e] mb-2">Gestão de Leitores</h2>
            <p className="text-[#45464d] max-w-md mx-auto">
              Aqui você pode visualizar, adicionar, editar e remover leitores da biblioteca.
            </p>
          </div>
        </div>
      </div>
